...
MCMCClusterization = TODELETE.OptionsClusterization(
    ...
    clustering_type     = "HDP-HMM-Joint"::String, # one of "HMM"
    # pi
    update_pi           = true::Bool,
    inits_pi            = InitPi,
...
for saveMCMCindex in 1:MCMCout.nsamplesave
    ...
    for burnithinMCMCindex in 1:appBurninOrThin
		...
		MCMCLikelihood[1].clusterization.zeta .-MCMCLikelihood[2].clusterization.zeta
		MCMCClusterization[1].zeta_mcmc .- MCMCClusterization[2].zeta
        ### ### ### ### ### ### ###
        ### ### CLUSTERIZATION
        ### ### ### ### ### ### ###
