...
HierarchicalParameters = TODELETE.OptionHierarchicalParameters(MCMCLikelihood)
...
for ian in 1:nanim
	MCMCout[ian] = TODELETE.OptionsMCMC(MCMCLikelihood[ian],MCMCClusterization[ian],HierarchicalParameters;
...
for saveMCMCindex in 1:MCMCout.nsamplesave
    ...
    for burnithinMCMCindex in 1:appBurninOrThin
		...
		TODELETE.sample_mu0_lv2!(MCMCLikelihood,MCMCLikelihood[1].mu,HierarchicalParameters)
		TODELETE.sample_muC_lv2!(MCMCLikelihood,MCMCLikelihood[1].eta,HierarchicalParameters)
		TODELETE.sample_rho_lv2!(MCMCLikelihood,MCMCLikelihood[1].rho,HierarchicalParameters)
		TODELETE.sample_psi_lv2!(MCMCLikelihood,MCMCLikelihood[1].nu,HierarchicalParameters)
		TODELETE.sample_sigma_lv2!(MCMCLikelihood,MCMCLikelihood[1].sigma,HierarchicalParameters)

		TODELETE.sample_prob_lv2!(MCMCClusterization, MCMCClusterization[1].pi,HierarchicalParameters)

		TODELETE.sample_beta!(MCMCClusterization, MCMCClusterization[1].pi,HierarchicalParameters)
		### ### ### ### ### ### ###
		### ### CLUSTERIZATION
		### ### ### ### ### ### ###
		...
		TODELETE.sample_ak!(MCMCClusterization, MCMCClusterization[1].pi,HierarchicalParameters)
		TODELETE.sample_rhodp!(MCMCClusterization, MCMCClusterization[1].pi,HierarchicalParameters)

		TODELETE.sample_gamma!(MCMCClusterization, MCMCClusterization[1].pi,HierarchicalParameters)
		...
		# zeta
		TODELETE.sample_zeta!(MCMCLikelihood, MCMCClusterization,MCMCLikelihood[1].clusterization)
        ...
        ### mu0 (mu)
		TODELETE.sample_mu0!(MCMCLikelihood,MCMCLikelihood[1].mu,HierarchicalParameters)

        ### sigma
        TODELETE.sample_sigma!(MCMCLikelihood, MCMCLikelihood[1].sigma,HierarchicalParameters)

        ### psi
        TODELETE.sample_psi!(MCMCLikelihood, MCMCLikelihood[1].nu,HierarchicalParameters)

		# eta
		TODELETE.sample_muC!(MCMCLikelihood,MCMCLikelihood[1].eta,HierarchicalParameters)

		# rho
		TODELETE.sample_rho!(MCMCLikelihood,MCMCLikelihood[1].rho,HierarchicalParameters)
    ...
    TODELETE.save_posteriorsamples!(MCMCout,MCMCLikelihood, MCMCClusterization,HierarchicalParameters)
